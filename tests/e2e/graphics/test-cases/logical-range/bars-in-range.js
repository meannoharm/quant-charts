...
function runTestCase(container) {
	...
	const bars1 = series.barsInLogicalRange({ from: 0, to: 9 });
	...
	const bars2 = series.barsInLogicalRange({ from: -5, to: 9 });
	...
	const bars3 = series.barsInLogicalRange({ from: 5, to: 14 });
	...
	const bars4 = series.barsInLogicalRange({ from: 4, to: 5 });
	...
	const bars5 = series.barsInLogicalRange({ from: -5, to: 14 });
