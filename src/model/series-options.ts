...
// 散点图设置
export type ScatterSeriesOptions = SeriesOptions<ScatterStyleOptions>;
export type ScatterSeriesPartialOptions = SeriesPartialOptions<ScatterStyleOptions>;
...
export interface SeriesOptionsMap {
	...
	/**
	 * The type of scatter series options.
	 */
...
export interface SeriesPartialOptionsMap {
	...
	/**
	 * The type of scatter series partial options.
	 */
	Scatter: ScatterSeriesPartialOptions;
}
