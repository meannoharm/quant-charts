...
import { ScatterSeriesPartialOptions } from './../model/series-options';
...
export interface IChartApi {
	 ...
	 * 创建散点图
	 *
	 * @param scatterOptions - 散点图配置
	 * @returns An interface of the created series.
	 * @example
	 * ```js
	 * const series = chart.addScatterSeries();
	 * ```
	 */
	addScatterSeries(scatterOptions?: ScatterSeriesPartialOptions): ISeriesApi<'Scatter'>;
